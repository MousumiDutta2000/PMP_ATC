            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="shadow-sm" name="project_name" id="project_name" value="{{ $project->project_name }}" required style="color: #858585; font-size: 14px;">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select id="typeSelect" class="shadow-sm" name="project_type" required style="padding-top:5px; padding-bottom:5px; height:39px; color: #858585; font-size: 14px;">
                ...
                <div class="col-md-12 mb-3">
                    <label for="project_description" class="mb-1 form-label" style="font-size: 15px;">Project Description</label>
                    <textarea class="ckeditor form-control" name="project_description" id="project_description" required placeholder="Describe the project" style="color: #858585; font-size: 14px;">{{ $project->project_description }}</textarea>
                </div>

                <div class="col-md-6 mb-3">
                    <label for="project_startDate" class="mb-1 form-label" style="font-size: 15px;">Project Start</label>
                    <input type="date" id="project_startDate" class="shadow-sm" name="project_startDate" value="{{ $project->project_startDate }}" required style="color: #858585; font-size: 14px;">
                </div>

                <div class="col-md-6 mb-3">
                    <label for="project_endDate" class="mb-1 form-label" style="font-size: 15px;">Project End</label>
                    <input type="date" id="project_endDate" class="shadow-sm" name="project_endDate" value="{{ $project->project_endDate }}" required style="color: #858585; font-size: 14px;">
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="project_status" class="form-label mb-1" style="margin-bottom: 0.3rem; font-size: 15px;">Status</label>
                        <select id="project_status" name="project_status" class="shadow-sm" required style="padding-top:5px; padding-bottom:5px; height:39px; color: #858585; font-size: 14px;">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="shadow-sm" name="client_spoc_name" id="client_spoc_name" value="{{ $project->client_spoc_name }}" required style="color: #858585; font-size: 14px;">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" class="shadow-sm" name="client_spoc_email" id="client_spoc_email" value="{{ $project->client_spoc_email }}" required style="color: #858585; font-size: 14px;">
                    </div>
                </div>
