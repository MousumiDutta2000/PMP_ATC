...
@section('content')
    ...
    <div class="form-container w-50">
        <div class="page-number text-secondary mb-2" id="page-number-1">Page 1 of 3</div>
        <form method="post" action="{{ route('profiles.store') }}" enctype="multipart/form-data">
            ...
            <div class="page-number" id="page-number-2" style="display: none;">Page 2 of 3</div>
            ...
            <div class="page-number" id="page-number-3" style="display: none;">Page 3 of 3</div>
