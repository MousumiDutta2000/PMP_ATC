...
>>>>>>> 5c7d5f2b9098b2f681437156250dbd8652c5ad64
                <thead>
                    <tr>
                        {{-- <th>ID</th> --}}
                        <th>Sprint Name</th>
                        ...
                        <tr class="shadow" style="border-radius:15px;">
                            ...
                            <td>
                                ...
                                @elseif($sprint->status == 'Pending')
                                    <div class="badge badge-danger-light text-danger font-weight-bold" style="background-color: #f1909b; margin-left:16px;">{{ $sprint->status }}</div>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="showModalLabel_{{ $sprint->id }}">Sprint Details</h5>
